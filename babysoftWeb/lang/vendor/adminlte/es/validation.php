...
return [
    ...
    | reglas tienen múltiples versiones tales como las reglas de tamaño.
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Los siguientes lenguajes son utilizados para sustituir el marcador de posición
    | del atributo con un nombre más legible por el usuario, como "Dirección de Correo Electrónico"
    | en lugar de "email". Esto simplemente ayuda a hacer nuestro mensaje más expresivo.
    |
    */
