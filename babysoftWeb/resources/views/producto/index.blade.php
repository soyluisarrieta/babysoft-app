                        ...
                        <span id="card_title" class="text-center" style="font-size: 33px; font-weight: bold;">
                            {{ __('Productos') }}
                             ...
                             <div class="float-right">
                                ...
                                <i class="fa fa-plus-circle" aria-hidden="true"></i>{{ __('Agregar Producto') }}
                                </a>
                              </div>
                        </div>
                    </div>
                ...
                @endif
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="prod" class="table table-striped table-hover">
                                <thead class="thead">
                                    <tr>
                                        <th>ID</th>
										<th>Referencia</th>
                                ...
                                <tbody>
                                    @foreach ($productos as $producto)
                                        <tr>
                                            ...
                                            <td>
                                                <form id="form" action="{{ route('productos.destroy',$producto->id) }}" class="formulario-eliminar" method="POST">
