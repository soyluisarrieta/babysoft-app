            ...
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                      ...
                      @endif
                        <form method="POST" class="formulario-editar" action="{{ route('proveedores.update', $proveedore->idProveedor) }}"  role="form" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            @csrf
                            ...
                            <div class="float-right">
                                <a class="btn btn-primary" href="{{ route('proveedores.index') }}"><i class="fa fa-arrow-left" aria-hidden="true"></i>ㅤ{{ __('Volver') }}</a>
                            </div>
